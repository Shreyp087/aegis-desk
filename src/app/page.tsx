...
function PanelFrame({
  ...
  return (
    <div className="glass-panel h-full min-h-0 flex flex-col overflow-hidden shadow-[0_8px_20px_rgba(53,103,148,0.14)]">
      <div className="panel-head px-5 py-4 flex items-center justify-between">
        <div>
          <div className="text-base font-semibold truncate heading-spectrum">{title}</div>
          {subtitle ? (
...
export default function Home() {
  ...
  }, [canRunAgent, command, docText, emailText, isRunning, offlinePublicEnforced]);
  ...
  return (
    <DesktopShell>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        <div className="text-sm text-[var(--muted)] subtle-pill px-4 py-2 rounded-full">
          {activeTab === "agent"
            ? "Shortcut: Ctrl/Cmd + Enter to run."
            : "Scan inbox and escalate risky emails to agent."}
        </div>
      </div>
      ...
      {activeTab === "inbox" ? (
        <div className="min-h-0">
          <PanelFrame
            title="Inbox Scanner"
            subtitle="Scan inbox, rank risks, and escalate selected emails to the main agent."
          >
            <InboxScannerPanel
        ...
        <>
          ...
          <div className="quick-template-row mb-3">
              ...
              actionButton={
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="secondary-ghost px-3 py-2 rounded-xl text-sm font-semibold"
                  >
                    Clear
                  </button>
                  <button
                    ...
                    className="primary-cta px-4 py-2.5 rounded-xl font-semibold active:scale-95 cursor-pointer transition-all duration-200 text-sm disabled:opacity-45 disabled:cursor-not-allowed"
                  >
